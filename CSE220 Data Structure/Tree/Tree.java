public class Tree{
  public static void main(String[]args){
    ...
    Node n2=new Node(20,null,null,null);
    n2.parent=n1;
    n1.left=n2;
    Node n3=new Node(30,null,null,null);
    n3.parent=n1;
    n1.right=n3;
    Node n4=new Node(40,null,null,null);
    n4.parent=n3;
    n3.left=n4;
    Node n5=new Node(50,null,null,null);
    n5.parent=n3;
    n3.right=n5;
    Node n6=new Node(60,null,null,null);
    n6.parent=n4;
    n4.left=n6;
    Node n7=new Node(70,null,null,null);
    n7.parent=n4;
    n4.right=n7;    
  ...
  public static int getHeight(Node r){
    if(r==null) 
      ...
      return 1+maxOf(getHeight(r.left),getHeight(r.right));
  }
  
  public static int maxOf(int l, int r){
    if(l>r)
      return l;
    else
      return r;
